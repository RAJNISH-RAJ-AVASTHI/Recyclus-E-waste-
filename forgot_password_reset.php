...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if ($confirmpassword==$password) {
            ...
            mysqli_query($con,"UPDATE users set password='$password', confirmpassword='$password' where email='$email'");
        }
        else{
      ...
      <div class="row"><br><br><br>
        ...
        <div class="col-md-4" style="background-color: #D2D1D1; border-radius:15px;">
          ...
          <form role="form" method="POST">
              ...
              <div class="form-group">
                <input type="password" class="form-control" id="pwd" name="confirmpassword" placeholder="Re-type Password">
              </div>
                  <?php if (isset($error)) {
